    ...
    return (del.trigger) ? ( 
        ...
        <div class ="delete_popup"> 
            ...
            <div className= "delete_popup-inner"> 
                ...
                <div class = "delete_Title">Are you sure you want to delete?</div> 

                <button class = "delete_no" onClick={() => del.setTrigger(false)}>No</button> 

                <button class = "delete_yes" onClick={() => del.setTrigger(false)}>Yes</button> 
...
function Dailies(){ 
  ...
  <body> 
        ...
        <div id = "div3"> 
            ...
            <table id = "table3"> 
                ...
                <tr> 
                    ...
                    <td><button class = "btn_delete" onClick ={() => setDelPopup(true)}><IoTrashOutline id ="delete" size="2.5vw" color="#000000"></IoTrashOutline></button></td> 
    ...
    <Delete trigger = {delPopup} setTrigger = {setDelPopup}></Delete>
